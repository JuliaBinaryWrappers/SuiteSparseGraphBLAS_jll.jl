module SuiteSparseGraphBLAS_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SuiteSparseGraphBLAS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("44cc8b2a-fe03-5802-9b90-2102cf0b4e7e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SuiteSparseGraphBLAS", artifacts_toml) for e in artifacts["SuiteSparseGraphBLAS"]]
...
if best_platform === nothing
    @debug("Unable to load SuiteSparseGraphBLAS; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module SuiteSparseGraphBLAS_jll
