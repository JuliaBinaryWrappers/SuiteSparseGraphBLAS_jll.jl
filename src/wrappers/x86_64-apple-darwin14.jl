# Autogenerated wrapper script for SuiteSparseGraphBLAS_jll for x86_64-apple-darwin14
export libgraphblas
...
const libgraphblas_splitpath = ["lib", "libgraphblas.3.1.1.dylib"]
...
const libgraphblas = "@rpath/libgraphblas.3.dylib"
